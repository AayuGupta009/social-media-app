...
export default function VolunteerRegistrationTable({
  rows,
  page,
  rowsPerPage,
  ...
  const columns = [
    ...
    { id: "title", label: `${t("table.req_title")}` },
    {
      id: "createdAt",
      label: `${t("table.date")}`,
      minWidth: 170,
                                  ...
                                  {row.isCompleted ? (
                                    ...
                                    <>
                                      ...
                                      <EditIcon
                                        onClick={() =>
                                          navigate(
                                            `/volunteer-management/edit-volunteer/${row._id}`
                                          )
                                        }
                                      />
                                    </>
                              ...
                              <div className="action-icon">
                                <div className="action-icon">
                                  <EyeIcon
                                    onClick={() =>
                                      navigate(
                                        `/volunteer-management/volunteer-applicants-list/${row?._id}`
                                      )
                                    }
                                  />
                                </div>
